...
["_bn_kernel_create","_bn_kernel_destroy","_bn_vfs_mkdir","_bn_vfs_write_text","_bn_vfs_write_bytes","_bn_vfs_read_text","_bn_vfs_unlink","_bn_vfs_readdir_json","_bn_vfs_exists","_bn_vfs_stat_json","_bn_spawn","_bn_wait","_bn_kill","_bn_read_stdout","_bn_read_stderr","_bn_write_stdin","_bn_register_builtins","_bn_free","_malloc","_free","_memory","___indirect_function_table","_main","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  4331056: ($0) => { if (typeof globalThis.__bn_on_server_ready === 'function') { globalThis.__bn_on_server_ready($0); } },  
 4331160: ($0) => { if (typeof globalThis.__bn_on_http_listen === 'function') { globalThis.__bn_on_http_listen($0); } }
};
...
var _bn_spawn = Module['_bn_spawn'] = createExportWrapper('bn_spawn', 4);
