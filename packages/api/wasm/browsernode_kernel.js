...
var ASM_CONSTS = {
  4416648: ($0, $1, $2) => { var tool = UTF8ToString($0); var cwd = UTF8ToString($1); var mode = UTF8ToString($2); if (typeof globalThis.__bn_on_tool === 'function') { globalThis.__bn_on_tool(tool, cwd, mode); } },  
 4416835: ($0, $1, $2, $3) => { var cwd = UTF8ToString($0); var action = UTF8ToString($1); var payload = UTF8ToString($2); var pid = $3; if (typeof globalThis.__bn_on_npm === 'function') { globalThis.__bn_on_npm(cwd, action, payload, pid); } },  
 4417049: ($0, $1, $2, $3) => { var pkg = UTF8ToString($0); var rest = UTF8ToString($1); var cwd = UTF8ToString($2); var pid = $3; if (typeof globalThis.__bn_on_npx === 'function') { globalThis.__bn_on_npx(pkg, rest, cwd, pid); } },  
 4417251: ($0) => { if (typeof globalThis.__bn_on_server_ready === 'function') { globalThis.__bn_on_server_ready($0); } },  
 4417355: ($0, $1, $2, $3, $4) => { try { if (typeof globalThis.__bn_wasm_http_dispatch !== 'function') return 0; var method = UTF8ToString($0); var path = UTF8ToString($1); var headers = UTF8ToString($2); var body = UTF8ToString($3); var port = $4; var out = globalThis.__bn_wasm_http_dispatch(port, method, path, headers, body); if (out == null) return 0; var s = String(out); var len = lengthBytesUTF8(s) + 1; var ptr = _malloc(len); stringToUTF8(s, ptr, len); return ptr; } catch (e) { return 0; } }
};
...
var _bn_kernel_create = Module['_bn_kernel_create'] = createExportWrapper('bn_kernel_create', 0);
var _bn_kernel_destroy = Module['_bn_kernel_destroy'] = createExportWrapper('bn_kernel_destroy', 1);
var _bn_free = Module['_bn_free'] = createExportWrapper('bn_free', 1);
var _bn_vfs_mkdir = Module['_bn_vfs_mkdir'] = createExportWrapper('bn_vfs_mkdir', 3);
var _bn_vfs_write_text = Module['_bn_vfs_write_text'] = createExportWrapper('bn_vfs_write_text', 3);
var _bn_vfs_write_bytes = Module['_bn_vfs_write_bytes'] = createExportWrapper('bn_vfs_write_bytes', 4);
var _bn_vfs_read_text = Module['_bn_vfs_read_text'] = createExportWrapper('bn_vfs_read_text', 2);
var _bn_vfs_read_bytes = Module['_bn_vfs_read_bytes'] = createExportWrapper('bn_vfs_read_bytes', 3);
var _bn_vfs_unlink = Module['_bn_vfs_unlink'] = createExportWrapper('bn_vfs_unlink', 2);
var _bn_vfs_rmdir = Module['_bn_vfs_rmdir'] = createExportWrapper('bn_vfs_rmdir', 2);
var _bn_vfs_rename = Module['_bn_vfs_rename'] = createExportWrapper('bn_vfs_rename', 3);
var _bn_vfs_readdir_json = Module['_bn_vfs_readdir_json'] = createExportWrapper('bn_vfs_readdir_json', 2);
var _bn_vfs_exists = Module['_bn_vfs_exists'] = createExportWrapper('bn_vfs_exists', 2);
var _bn_vfs_stat_json = Module['_bn_vfs_stat_json'] = createExportWrapper('bn_vfs_stat_json', 3);
var _bn_vfs_lstat_json = Module['_bn_vfs_lstat_json'] = createExportWrapper('bn_vfs_lstat_json', 3);
var _bn_vfs_symlink = Module['_bn_vfs_symlink'] = createExportWrapper('bn_vfs_symlink', 3);
var _bn_vfs_readlink = Module['_bn_vfs_readlink'] = createExportWrapper('bn_vfs_readlink', 2);
var _bn_spawn = Module['_bn_spawn'] = createExportWrapper('bn_spawn', 5);
var _bn_http_dispatch = Module['_bn_http_dispatch'] = createExportWrapper('bn_http_dispatch', 6);
var _bn_wait = Module['_bn_wait'] = createExportWrapper('bn_wait', 2);
var _bn_pump = Module['_bn_pump'] = createExportWrapper('bn_pump', 2);
var _bn_vfs_extract_tar = Module['_bn_vfs_extract_tar'] = createExportWrapper('bn_vfs_extract_tar', 4);
var _bn_vfs_usage = Module['_bn_vfs_usage'] = createExportWrapper('bn_vfs_usage', 1);
var _bn_kill = Module['_bn_kill'] = createExportWrapper('bn_kill', 2);
